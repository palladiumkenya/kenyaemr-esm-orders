...
import styles from './medical-supply-order-basket-item-tile.scss';
...
export function MedicalSupplyOrderBasketItemTile({
  orderBasketItem,
  onItemClick,
  onRemoveClick,
...
function OrderActionLabel({ orderBasketItem }: { orderBasketItem: MedicalSupplyOrderBasketItem }) {
  const { t } = useTranslation();
